...
r = readers()
if not r:
    raise Exception("No smart card readers found. Ensure the device is connected.")
...
print(f"First Name: {parsed_data.get(FIRST_NAME_TAG, 'Not found')}")
print(f"Last Name: {parsed_data.get(LAST_NAME_TAG, 'Not found')}")
print(f"Birthdate: {parsed_data.get(BIRTHDATE_TAG, 'Not found')}")
