...
from src.backend.backend import account_exists
...
def page():
    global SPECIMEN_FRONT, SPECIMEN_BACK, card_moving_up, card_move_up_animation, card_move_down_animation, specimen_back_rect, card_state, card_in_reader, account_exist
    ...
    if data.APP.drawElements():
        ...
        if name_text.text == "" and data.card_data is not None:
            ...
            if account_exists(data.card_data["rrn"]):
                account_exist = True
